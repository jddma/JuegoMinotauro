...
public class Board extends JPanel implements ActionListener {
    ...
    private void initBoard() throws Exception {
        ...
        //Objetos del juego.
        circle = new Circle(465,170,30,30);
    ...
    private Muro[] DefinirMuros() {	   	
    	return new Muro[]{new Muro(30,10,5,470),new Muro(30,10,980,5),new Muro(980+30,10,5,470),new Muro(30,480,425,5),new Muro(490,480,525,5),
			 ...
			 new Muro(325,300,40,5),new Muro(365,335,45,5),new Muro(405,370,5,40),new Muro(405,370,40,5),new Muro(210,405,195,5),
			 ...
			 new Muro(490,205,5,55),new Muro(495,165,35,5)};
    }
